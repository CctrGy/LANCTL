...
install -m 0755 dist/landemo "$PORTABLE/LANCTL/landemo"
...
install -m 0755 dist/landemo "$PKG/opt/lanctl/landemo"
...
ln -s /opt/lanctl/landemo "$PKG/usr/bin/landemo"
