...
ENGLISH_STRINGS: dict[str, str] = {
    ...
    "LANCTL.CORE.APP.GUI_RESERVED": "Open the LANCTL graphical interface (reserved for a future version).",
...
SPANISH_STRINGS: dict[str, str] = {
    ...
    "LANCTL.CORE.APP.GUI_RESERVED": "Abre la interfaz gráfica de LANCTL (reservado para una versión futura).",
