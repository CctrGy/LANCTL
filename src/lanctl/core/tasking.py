...
from lanctl.core.errors import ErrorEvent, LanctlError
...
def result(
    ...
    *,
    ...
    error_event: ErrorEvent | LanctlError | None = None,
) -> OperationResult:
    finished = utc_now()
    error = None
    if error_event is not None:
        event = error_event.event if isinstance(error_event, LanctlError) else error_event
        error = event.to_dict()
    elif code:
