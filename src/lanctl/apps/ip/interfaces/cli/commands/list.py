...
from lanctl.apps.ip.infrastructure.services.scan_profiles import SCAN_PROFILES, apply_profile
from lanctl.apps.ip.interfaces.cli.commands.recurrent import run_recurrent
