...
from lanctl.apps.ip.infrastructure.protocols.ssh import SshProfile, run_remote_command
from lanctl.apps.ip.infrastructure.services.element_scanner import ping_details
from lanctl.apps.ip.infrastructure.services.lan_scanner import active_arp_mac
from lanctl.core.conditions import ConditionContext, duration, evaluate, parse_condition
...
from lanctl.core.plugins.wol_runtime import send_magic_packet, validate_mac
from lanctl.core.tasking import TASK_ID, JsonStore, result, utc_now
...
def _wake(
    ...
    try:
        ...
        event = errors.from_exception(
            error,
            origin="LANCTL.WOL.Resolve.Device",
    ...
    try:
        ...
        event = errors.from_exception(
            error,
            origin="LANCTL.WOL.Send.Network",
            code="WOL.SEND.ERROR",
            level=46,
            details={"target": str(target), "method": method},
            print_output=False,
        )
        return result(
            task_id,
